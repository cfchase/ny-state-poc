...
oc process ${params} -f templates/llms/llm_ds_project.yaml | oc apply --dry-run=client -o yaml -f -
...
#oc process ${params} -f templates/llms/s3_ds_connection.yaml | oc apply -n ${LLM_PROJECT_NAME} --dry-run=client -o yaml -f -
...
#oc process ${params} -f templates/llms/served_model.yaml | oc apply -n ${LLM_PROJECT_NAME} --dry-run=client -o yaml -f -
